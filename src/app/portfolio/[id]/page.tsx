...
const portfolioData = {
  1: {
    ...
    overview:
      "We successfully designed and implemented a 5MW solar power plant for one of India's leading industrial manufacturers. This project involved comprehensive site assessment, custom solar panel arrangement, and seamless grid integration.",
    challenges: [
      "Limited roof space",
    ...
    testimonial: {
      quote:
        "VNB Power's expertise in solar energy solutions exceeded our expectations. The project was completed on time and has already shown significant cost savings.",
  ...
  2: {
    ...
    overview:
      "Led a comprehensive digital transformation initiative for a major financial services firm, migrating legacy systems to cloud infrastructure and implementing AI-driven automation.",
    challenges: [
    ...
    testimonial: {
      quote:
        "The digital transformation has revolutionized our operations. We're now more efficient, secure, and ready for the future.",
      author: "CTO",
  ...
  3: {
    ...
    overview:
      "Transformed traditional classrooms into modern learning environments by deploying interactive flat panels and comprehensive digital learning solutions across 50 government schools.",
    challenges: [
      "Budget constraints",
    ...
    testimonial: {
      quote:
        "The smart classroom initiative has transformed how our students learn. Teachers are more engaged, and students are excited about education.",
  ...
  4: {
    ...
    overview:
      "Undertook a complete infrastructure modernization project for a major manufacturing facility, upgrading network systems, implementing advanced security, and building a state-of-the-art data center.",
    challenges: [
    ...
    testimonial: {
      quote:
        "The infrastructure upgrade has been game-changing. Our operations are more reliable and efficient than ever before.",
      author: "IT Director",
  ...
  5: {
    ...
    image:
      "https://images.unsplash.com/photo-1508514177221-188b1cf16e9d?w=1200&h=800&fit=crop&q=80",
    tags: ["Rooftop Solar", "Net Metering", "Maintenance"],
    impact: "200+ homes powered",
    overview:
      "Successfully executed a large-scale rooftop solar installation program across multiple cities, helping residential and commercial clients transition to clean energy.",
    challenges: [
      "Varied roof types",
    ...
    testimonial: {
      quote:
        "Going solar with VNB Power was the best decision. The process was smooth, and we're already seeing significant savings on our electricity bills.",
  ...
  6: {
    ...
    overview:
      "Developed a comprehensive e-learning platform featuring interactive content, real-time assessments, and mobile accessibility for a leading educational institution.",
    challenges: [
    ...
    testimonial: {
      quote:
        "The e-learning platform has transformed how we deliver education. Student engagement and outcomes have improved significantly.",
      author: "Principal",
...
export default function PortfolioCaseStudy({
  ...
  const project =
    portfolioData[params.id as unknown as keyof typeof portfolioData];
      ...
      <>
        ...
        <main className="min-h-screen bg-white pt-24 flex items-center justify-center">
          <div className="text-center">
            ...
            <Link
              href="/portfolio"
              className="inline-flex items-center gap-2 text-vnb-blue font-medium hover:gap-3 transition-all"
            >
          ...
          <div className="container mx-auto px-6">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {Object.entries(portfolioData)
                .filter(
                  ([id, p]) =>
                    id !== params.id && p.category === project.category,
                )
                .slice(0, 3)
