            ...
            <div className="lg:w-1/2">
              ...
              >
                <h2 className="text-5xl md:text-7xl font-bold mb-10 leading-[1.1] tracking-tighter">
                  Engineering the <br />
                  <span className="text-vnb-blue italic font-light">
                    Unimaginable
                  </span>
                </h2>
                <p className="text-slate-500 text-xl mb-12 leading-relaxed max-w-xl">
                  ...
                  interactive and sustainable future. We combine advanced
                  hardware with intuitive software to create experiences that
                  empower.
                </p>
                  ...
                  {[
                    {
                      ...
                      desc: "Built for extreme durability",
                    },
                    {
                    ...
                    {
                      title: "Cloud-native",
                      desc: "Seamless digital ecosystem",
                    },
                  ].map((feature, i) => (
                    <motion.div
                      key={feature.title}
