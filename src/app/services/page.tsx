          ...
          <div className="container mx-auto px-6 relative z-10">
            ...
            >
              ...
              <p className="text-lg md:text-2xl text-slate-400 max-w-3xl mx-auto leading-relaxed font-light">
                From renewable energy systems to next-generation education
                technology, we provide the building blocks for a smarter, more
                efficient world.
              </p>
            </motion.div>
          </div>
              ...
              {services.map((service, index) => (
                ...
                >
                  ...
                  <div className="relative z-10 p-12 flex flex-col h-full">
                    <div
                      className={`w-16 h-16 rounded-2xl ${service.accent} flex items-center justify-center text-white mb-10 shadow-lg`}
                    >
                      {service.icon}
                    </div>
                    ...
                    <div className="flex flex-wrap gap-3 mb-10">
                      {service.features.map((feature, i) => (
                        <span
                          key={i}
                          className="px-4 py-2 bg-white rounded-full text-sm font-semibold text-gray-600 border border-gray-100 shadow-sm group-hover:border-vnb-blue/20 transition-colors"
                        >
                          {feature}
                        </span>
                      ))}
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between mb-20 gap-8">
              <div>
                ...
                <p className="text-slate-400 text-xl max-w-xl">
                  Leverage our specialized expertise to drive innovation across
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {additionalServices.map((service, index) => (
                ...
                >
                  ...
                  <Link
                    href="/contact"
                    className="inline-flex items-center gap-2 text-sm font-bold text-vnb-green group-hover:gap-4 transition-all"
                  >
            ...
            >
              <div className="bg-[#020617] rounded-[3.8rem] py-24 px-12 overflow-hidden relative">
                ...
                <p className="text-xl text-slate-400 mb-12 max-w-2xl mx-auto leading-relaxed">
                  Join hundreds of organizations that have modernized their
                  operations with our industry-leading solutions.
                </p>
