...
const projects = [
  ...
  },
  {
    ...
    category: "VNB Solar",
    description:
      "Large-scale solar installations powering manufacturing facilities",
    image:
  ...
  },
  {
    ...
    description:
      "Interactive learning solutions for modern educational institutions",
    image:
  ...
  },
  {
    ...
    category: "VNB Solar",
    description:
      "Energy-efficient solar systems for retail and commercial spaces",
    image:
      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Delivering exceptional results across technology, solar energy, and
